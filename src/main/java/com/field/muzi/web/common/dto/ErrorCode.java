...
public enum ErrorCode {
    ...
    SCHOOL_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1049", "학교 정보가 존재하지 않습니다."),
    STUDY_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1050", "유학 정보가 존재하지 않습니다."),
    STUDY_INVALID_USER(HttpStatus.BAD_REQUEST.value(), "MZS-1051", "유학 정보와 사용자 정보가 일치하지 않습니다."),
    RESUME_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1052", "회사 이력 정보가 존재하지 않습니다."),
    RESUME_INVALID_USER(HttpStatus.BAD_REQUEST.value(), "MZS-1053", "회사 이력 정보와 사용자 정보가 일치하지 않습니다."),
    VISA_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1054", "E-7-4 비자 자동배점 신청 내역이 존재하지 않습니다."),
    VISA_INVALID_USER(HttpStatus.BAD_REQUEST.value(), "MZS-1055", "E-7-4 비자 자동배점 신청 내역과 사용자 정보가 일치하지 않습니다."),
    ALREADY_REQUEST_VISA(HttpStatus.BAD_REQUEST.value(), "MZS-1056", "E-7-4 비자 자동배점 신청 내역과 사용자 정보가 일치하지 않습니다."),
    TOUR_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1057", "여행 코스가 존재하지 않습니다."),
    BOARD_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1058", "게시글이 존재하지 않습니다."),
    BOARD_INVALID_USER(HttpStatus.BAD_REQUEST.value(), "MZS-1059", "게시글과 사용자 정보가 일치하지 않습니다."),
    TRIP_NOT_FOUND(HttpStatus.BAD_REQUEST.value(), "MZS-1060", "여행 예약 내역이 존재하지 않습니다."),
