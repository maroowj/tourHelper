...
public class MailService {
    ...
    public void  sendReservationMail(ReservationInsertRequest request) throws Exception {
        ...
        // 로컬
//        FileSystemResource logo = new FileSystemResource(new File("").getAbsolutePath()+"/src/main/resources/tourhelperUser/images/logo/ogSchoolTriplogo.png");
//        FileSystemResource step = new FileSystemResource(new File("").getAbsolutePath()+"/src/main/resources/tourhelperUser/images/admin/stepImage.png");
//        FileSystemResource refund = new FileSystemResource(new File("").getAbsolutePath()+"/src/main/resources/tourhelperUser/images/admin/refundImage.png");

        // 배포
        FileSystemResource logo = new FileSystemResource(new File("").getAbsolutePath()+"/tomcat/webapps/ROOT/WEB-INF/classes/tourhelperUser/images/logo/ogSchoolTriplogo.png");
        FileSystemResource step = new FileSystemResource(new File("").getAbsolutePath()+"/tomcat/webapps/ROOT/WEB-INF/classes/tourhelperUser/images/admin/stepImage.png");
        FileSystemResource refund = new FileSystemResource(new File("").getAbsolutePath()+"/tomcat/webapps/ROOT/WEB-INF/classes/tourhelperUser/images/admin/refundImage.png");
