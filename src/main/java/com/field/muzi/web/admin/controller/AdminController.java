...
public class AdminController {
    ...
    public String adminMain(HttpServletRequest request) {
        return "redirect:/admin/first-course";
    }
...
//    }
    ...
    //여행지 예약관리
    @GetMapping("/reservation/tour")
    public String tourReservation(){
        return "/admin/reservation/tour";
    }

    //유학관리
    @GetMapping("/reservation")
    public String abroadReservation(){
    ...
    @GetMapping("/E74")
    public String E74(){
        return "/admin/E74/list";
    }

    //E-7-4 자동배점 답변 내용 확인하기
    @GetMapping("/E74/answer/{visaSeq}")
    public String E74Answer(@PathVariable("visaSeq") String visaSeq){
        return "/admin/E74/answer";
    }
