...
public class FormAPI {
    ...
    @PostMapping("/form")
    public void createForm(@RequestBody FormSaveRequest request) {
        formService.createForm(request);
    }

    @PutMapping("/form/{formSeq}")
    public void updateForm(@RequestBody FormUpdateRequest request, @PathVariable("formSeq") String formSeq) {
