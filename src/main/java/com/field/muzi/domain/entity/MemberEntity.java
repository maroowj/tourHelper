...
public class MemberEntity extends BaseTimeEntity implements UserDetails {
	...
	public static MemberEntity adminCreate(String memberId, String memberPwd, String role) {
		MemberEntity member = new MemberEntity();
		member.setMemberId(memberId);
		member.setPassword(memberPwd);
		if(role.equals("ADMIN")) {
			member.setRoles(Collections.singletonList(Role.ADMIN));
		}else if(role.equals("SUB")) {
			member.setRoles(Collections.singletonList(Role.SUB));
		}
