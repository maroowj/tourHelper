...
public class MemberInfoEntity {
	...
	public void updateProfile(String name, String tel, String preference1, String preference2, String country) {
		this.setName(name);
		this.setTel(tel);
		this.setPreference1(preference1);
		this.setPreference2(preference2);
