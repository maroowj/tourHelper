...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
                ...
                .antMatchers(HttpMethod.PUT, "/exception/**", "/api/common/**").permitAll()
                ...
                .antMatchers("/admin/first-course/**", "/admin/second-course/**", "/api/admin/**").hasAnyRole("SUB", "ADMIN")
                .antMatchers("/admin/**").hasRole("ADMIN")
                .antMatchers("/mypage","/api/user/**", "/consult").hasAnyRole("USER", "ADMIN", "SUB")
//                .antMatchers("/first-course/**").hasRole("USER")
