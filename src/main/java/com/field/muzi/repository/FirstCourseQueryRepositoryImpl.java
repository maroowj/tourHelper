...
public class FirstCourseQueryRepositoryImpl extends QuerydslRepositorySupport implements FirstCourseQueryRepository {
    ...
    @Override
    public Page<CourseFirstLIstResponse> firstCourseList(CourseFirstListRequest request, Pageable pageable) {
        ...
        JPAQuery<CourseFirstLIstResponse> query = queryFactory
                .select(Projections.constructor(CourseFirstLIstResponse.class,
                        ...
                        Projections.constructor(AllCourseListResponse.Img.class,
                                ...
                                dir.dirUrl.append("/").append(firstCourseEntity.thumbnailImage.fileName)).skipNulls(),
    ...
    private BooleanExpression searchByKeyword(String keyword) {
        return keyword != null ? firstCourseEntity.firstCourseTitle.contains(keyword) : null;
    }
}
